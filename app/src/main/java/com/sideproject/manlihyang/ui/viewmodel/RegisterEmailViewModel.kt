...
import com.sideproject.manlihyang.util.extension.combinelivedata
...
class RegisterEmailViewModel(
    ...
    fun duplicationChecked() {
        ...
        if(isValidEmail.value!! && isNotBlankEmail.value!!) {
            onBoardingdataSource.checkForDuplication(
...
/*
    ...
    fun onNextClicked() {
        ...
        onBoardingdataSource.createUser(
            UserCreateRequest(
    ...
    fun back() = getNavigator().backActivity()
}